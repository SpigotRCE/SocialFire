...
public class VelocityAdminCommand {
    ...
    public VelocityAdminCommand() {
        VelocityFire.PROXY_SERVER.getCommandManager().register(
                VelocityFire.PROXY_SERVER.getCommandManager().metaBuilder("socialfire")
                        .aliases("socialfire").plugin(VelocityFire.INSTANCE).build(),
                this.build()
        );
    }
                ...
                .then(LiteralArgumentBuilder.<CommandSource>literal("announce")
                        ...
                        .then(RequiredArgumentBuilder.<CommandSource, String>argument("name", StringArgumentType.word())
                                .suggests((ctx, builder) -> {
                                    ...
                                    VelocityFire.CONFIG.getLinks().keySet().stream()
                                ...
                                .executes(context -> {
                                    ...
                                    VelocityFire.PROXY_SERVER.getAllPlayers().forEach(
                                            player -> VelocityFire.ANNOUNCEMENT_MANAGER.sendAnnouncement(
                                                    player,
